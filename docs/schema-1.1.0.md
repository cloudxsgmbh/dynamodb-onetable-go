...
This document specifies the [DynamoDB OneTable](https://github.com/sensedeep/dynamodb-onetable) Schema used to define application entities and their fields. This Go port follows the same schema format (`SchemaDef` in `schema.go`).
